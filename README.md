...
These insturctions were adapted from [www.earthdatascience.org](www.earthdatascience.org).
...
Download the installer: Anaconda installer for Linux. Be sure to download the Python 3.x version!

In your Terminal window, run: bash Anaconda-latest-Linux-x86_64.sh
